...
export const adminCreateCourseController = async (req: Request, res: Response) => {
  try {
    const schemaValidation = z.object({
...
export const adminDeleteCourseController = async (req: Request, res: Response) => {
  try {
...
export const adminUpdateCourseController = async (req: Request, res: Response) => {
  try {
  } catch (error) {}
};